...
'''
import pylab as pb
import fast_synapse_T as fast_synapse  
import slow_synapse_T as slow_synapse
...
class pop1n(object):
    ...
    def __init__(self, a=1., b=3., c=1., d=5., m=0.6, s=4., x0=-1.6, z0=0., r=0.00035, I1=3.1, CpES=0.1, CpCS=0.9, g_x1x1=0., g_x2x1=0.5, g_x2x1_slow=1., noise=2, noise3=0.1):
        ...
        self.x1=0.; self.y1=0.; self.z=0.;
        self.x0=x0
        self.noise=noise
        self.noise3=noise3
        
        #synapse management syntax: syn_ pre post
        self.syn_x1x1 = fast_synapse.fast_synapse(g_x1x1,0,1.1, 0.19, 2) #params: gbar, E, alpha, beta, Vt
        self.syn_x2x1 = fast_synapse.fast_synapse(g_x2x1,uniform(-80,-50),5, 0.18, 2) #params: gbar, E, alpha, beta, Vt
        self.syn_x2x1_slow = slow_synapse.slow_synapse(g_x2x1_slow,-95,0.09,0.0012, 2) 
