...
class slow_synapse(object):
    ...
    def __init__(self, g_bar, E, alpha, beta, Vt):
        '''
        Constructor
        '''
        """self.Tmax=1; self.VT=2; self.Kp=5;
        self.Vampa=0; self.a_r=1.1; self.a_d=0.19;"""
        self.gmax=g_bar; self.Esyn=E; self.a=alpha; self.b=beta; self.Cmax=0.5; self.threshold=0; self.Cdur=0.3; self.deadtime=1;        
        self.lr=-1000; #last release initialization
        self.m=0;  self.m0=0; self.tau_r=1/(self.a*self.Cmax+self.b); self.m1=0;
        self.Kd=100; self.K3=0.18; self.K4=0.034; self.n=4;
        self.r=0; self.s=0;
        self.Vt=Vt
        self.C_plot=[]
